...
_CeruleanHouse2Text_74eb4::
	text "Your MAGIKARP's"
	line "SPECIAL abilities"
	cont "increase a bit."
	prompt

_CeruleanHouse2Text_74eb9::
	text "All MAGIKARP will"
	line "obey you!"
	prompt
